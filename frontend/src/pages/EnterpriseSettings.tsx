...
const FALLBACK_LLM_PROVIDERS: LLMProviderSpec[] = [
    ...
    { provider: 'kimi-code', display_name: 'Kimi Code', protocol: 'openai_compatible', default_base_url: 'https://api.kimi.com/coding/v1', supports_tool_choice: true, default_max_tokens: 8192 },
